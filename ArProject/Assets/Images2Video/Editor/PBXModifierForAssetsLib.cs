...
namespace Images2Video.Editor {
	public class PBXModifierForAssetsLib {
		const string assetsLibrary1 = "6A6D49D41F6C5E7000772A8B /* AssetsLibrary.framework in Frameworks */ = {isa = PBXBuildFile; fileRef = 6A4B51BA1A25A3880063B77B /* AssetsLibrary.framework */; };\n";
		...
		const string assetsLibrary3 = "6A6D49D41F6C5E7000772A8B /* AssetsLibrary.framework in Frameworks */,";
		...
		/// </summary>
		public PBXModifierForAssetsLib() {}
